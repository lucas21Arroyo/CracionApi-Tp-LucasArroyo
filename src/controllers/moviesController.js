...
const traslatte = require('translatte')

//Aqui tienen otra forma de llamar a cada uno de los modelos
const Movies = db.Movie;
const Genres = db.Genre;
const Actors = db.Actor;
const API = 'http://www.omdbapi.com/?i=tt3896198&apikey=82e9efeb';
    ...
    search : (req,res) => {
        ...
        db.Movie.findAll({
            ...
            if(!movies.length){
                ...
                const awardsPareseado = awardsArray.map(award => +award)
                const awards = awardsPareseado.reduce((acum,num) => acum + +num,0)
                ...
                if(newGenre){
                const {text} = await traslatte(newGenre, {to : 'es'})//traduce el genero
